...
export class FileDownloadUploadService {
  ...
  downloadEwayBill1(aspid:string ,password:string,  gstin:string,  printEWayBill: string):Observable<Blob>{    
    return this.http.post(`https://cors-anywhere.herokuapp.com/https://api.taxprogsp.co.in/aspapi/v1.0/printewb?aspid=` + aspid+'&password='+password+'&gstin='+gstin,printEWayBill ,{ responseType: "blob" } );
