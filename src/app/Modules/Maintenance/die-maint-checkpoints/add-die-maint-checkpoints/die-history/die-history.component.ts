...
@Component({
  selector: 'app-die-history',
  templateUrl: './die-history.component.html',
  styleUrls: ['./die-history.component.css']
})
export class DieHistoryComponent implements OnInit {
  token:any;  original_url = environment.baseUrl;
  datePipe = new DatePipe("en-US");
  isLoadingResults=false;
  fendDate:any;
  allData:any={};
  title:any;telephone:any;
  GSTIn:any;PlanNo:any;
  printFor="";
  repeatHeaders=true;
     ...
     @Inject(MAT_DIALOG_DATA) public data: any) 
  {
    ...
    this.isLoadingResults=true;
     this.http.get(this.original_url+"/Maintenance/DieMaint/getdiehistoryreport?coid="+this.globalVar.CommpanyId+"&boid="+this.globalVar.BranchId+"&fyid="+this.globalVar.fyid+"&dieid="+data.dieid+"&fromdate="+data.fromdate+"&todate="+data.todate)
     .subscribe((res)=>{
      this.allData=res;
      this.Diehistoryitemarray=this.allData.Table;
      this.Diehistoryarray=this.allData.Table[0];
