...
@Component({
  selector: 'app-otwith-gate-pass',
  templateUrl: './otwith-gate-pass.component.html',
  styleUrls: ['./otwith-gate-pass.component.css']
})
export class OTWithGatePassComponent implements OnInit {
  ...
  constructor( private http: HttpClient,private excelService:ExcelService) {
    ...
    this.mydata='Employee OT with Gate Pass list From ' +  this.fromDate + " To " + this.toDate ;
    this.gatLoadData();
  }
  ...
  gatLoadData()
  {
    ...
    this.http.get(this.original_url+"/HR/HR/getGatePassedWithOT?fromdate="+this.fromDate+"&todate="+this.toDate+"&token="+this.token).subscribe((res:any[])=>{
    this.apiData=res;
