...
@Component({
  selector: 'app-employee-gate-pass-list-report',
  templateUrl: './employee-gate-pass-list-report.component.html',
  styleUrls: ['./employee-gate-pass-list-report.component.css']
})
export class EmployeeGatePassListReportComponent implements OnInit {
  ...
  constructor( private http: HttpClient,private excelService:ExcelService) {
    ...
    this.mydata='Employee Gate-Pass list From ' +  this.fromDate + " To " + this.toDate ;
    this.gatLoadData();
  }
  ...
  gatLoadData()
  {
    ...
    this.http.get(this.original_url+"/HR/HR/getGatePassListReport?pfromdate="+this.fromDate+"&ptodate="+this.toDate+"&token="+this.token).subscribe((res:any[])=>{
    this.apiData=res;
