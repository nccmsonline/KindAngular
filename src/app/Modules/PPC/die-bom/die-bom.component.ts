...
import { map, merge, startWith, switchMap } from 'rxjs/operators';
...
@Component({
  selector: 'app-die-bom',
  templateUrl: './die-bom.component.html',
  styleUrls: ['./die-bom.component.css']
})
export class DieBomComponent implements OnInit {
