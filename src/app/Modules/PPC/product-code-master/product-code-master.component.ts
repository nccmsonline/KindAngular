...
@Component({
  selector: 'app-product-code-master',
  templateUrl: './product-code-master.component.html',
  styleUrls: ['./product-code-master.component.css']
})
export class ProductCodeMasterComponent implements OnInit {
  ...
  displayedColumns : string[] = [  'PRODUCTCODE','CUSTOMERNAME','CREATEDON'];
...
{
  var ID=data.ID;
  this.router.navigate(['/add-product-code-master/'+ID+'/edit']);
}
...
refreshmachine()
{
  ...
  this.http.get(this.original_url+ "/Masters/ProductMaster/getproductmstlist?coid="+this.globalVar.CommpanyId+"&boid="+this.globalVar.BranchId+"&Pagenumber=1&Pagesize=100")
  .subscribe((data: any[]) => {
