...
@Component({
  selector: 'app-add-drawing-master-popup',
  templateUrl: './add-drawing-master-popup.component.html',
  styleUrls: ['./add-drawing-master-popup.component.css']
})
export class AddDrawingMasterPopupComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<AddDrawingMasterPopupComponent>,private translate: TranslateService,
