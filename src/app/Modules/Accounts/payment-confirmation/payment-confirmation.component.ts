...
export class PaymentConfirmationComponent implements OnInit {
  ...
  displayedColumns: string[] = [ 'REQNO','MORE','REQDATE','NAME','CREDITDAYS','REMARKS','TOTALDUEAMT','DUEAMT','PAYMENTTYPE','AMOUNTTOPAY','PASSEDAMT','MANAGEMENTNOTES'];
  ...
  ConfimPayments()
  {
    ...
    const dialogRef = this.dialog.open(ConfirmationDialogComponent, {
      data: {
        dailogType:'OTP',
        msg:'OTP for payment confirmation'
      }
    });
