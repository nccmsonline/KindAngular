...
@Component({
  selector: 'app-sheet-requirement-from-store',
  templateUrl: './sheet-requirement-from-store.component.html',
  styleUrls: ['./sheet-requirement-from-store.component.css']
})
export class SheetRequirementFromStoreComponent implements OnInit {
