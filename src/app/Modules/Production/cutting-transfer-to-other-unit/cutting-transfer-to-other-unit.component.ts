...
@Component({
  selector: 'app-cutting-transfer-to-other-unit',
  templateUrl: './cutting-transfer-to-other-unit.component.html',
  styleUrls: ['./cutting-transfer-to-other-unit.component.css']
})
export class CuttingTransferToOtherUnitComponent implements OnInit {
