...
@Component({
  selector: 'app-add-cutting-transfer-to-other-unit',
  templateUrl: './add-cutting-transfer-to-other-unit.component.html',
  styleUrls: ['./add-cutting-transfer-to-other-unit.component.css']
})
export class AddCuttingTransferToOtherUnitComponent implements OnInit {
  ...
  constructor(
    ...
    this.createForm();
    this.contacts=[
      {id:1,grade:"50C600",width:"1000",thickness:"0.5",weight:"6.05",coilno:"MCH21/3423"} ,      
      {id:1,grade:"40C600",width:"2000",thickness:"0.9",weight:"4.05",coilno:"NJH21/8623"} ,                                                                      
      {id:1,grade:"30C600",width:"1500",thickness:"0.3",weight:"9.05",coilno:"NCH21/3453"} ,                                      
