...
@Component({
  selector: 'app-die-planning-for-press-shop',
  templateUrl: './die-planning-for-press-shop.component.html',
  styleUrls: ['./die-planning-for-press-shop.component.css']
})
export class DiePlanningForPressShopComponent implements OnInit {
