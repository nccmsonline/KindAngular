...
@Component({
  selector: 'app-tool-room-inspection-master',
  templateUrl: './tool-room-inspection-master.component.html',
  styleUrls: ['./tool-room-inspection-master.component.css']
})
export class ToolRoomInspectionMasterComponent implements OnInit {
