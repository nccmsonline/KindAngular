...
@Component({
  selector: 'app-material-movement-slip-outward',
  templateUrl: './material-movement-slip-outward.component.html',
  styleUrls: ['./material-movement-slip-outward.component.css']
})
export class MaterialMovementSlipOutwardComponent implements OnInit {
