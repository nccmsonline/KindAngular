...
@Component({
  selector: 'app-rotor-die-casting-production',
  templateUrl: './rotor-die-casting-production.component.html',
  styleUrls: ['./rotor-die-casting-production.component.css']
})
export class RotorDieCastingProductionComponent implements OnInit {
