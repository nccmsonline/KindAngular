...
@Component({
  selector: 'app-coil-transfer-to-other-unit',
  templateUrl: './coil-transfer-to-other-unit.component.html',
  styleUrls: ['./coil-transfer-to-other-unit.component.css']
})
export class CoilTransferToOtherUnitComponent implements OnInit {
