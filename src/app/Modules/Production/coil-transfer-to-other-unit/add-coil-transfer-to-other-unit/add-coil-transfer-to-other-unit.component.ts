...
@Component({
  selector: 'app-add-coil-transfer-to-other-unit',
  templateUrl: './add-coil-transfer-to-other-unit.component.html',
  styleUrls: ['./add-coil-transfer-to-other-unit.component.css']
})
export class AddCoilTransferToOtherUnitComponent implements OnInit {
