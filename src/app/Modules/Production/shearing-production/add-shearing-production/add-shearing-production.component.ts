...
@Component({
  selector: 'app-add-shearing-production',
  templateUrl: './add-shearing-production.component.html',
  styleUrls: ['./add-shearing-production.component.css']
})
export class AddShearingProductionComponent implements OnInit {
