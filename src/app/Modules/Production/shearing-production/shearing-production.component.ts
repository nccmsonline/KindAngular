...
@Component({
  selector: 'app-shearing-production',
  templateUrl: './shearing-production.component.html',
  styleUrls: ['./shearing-production.component.css']
})
export class ShearingProductionComponent implements OnInit {
