...
@Component({
  selector: 'app-material-transfer-to-blanking',
  templateUrl: './material-transfer-to-blanking.component.html',
  styleUrls: ['./material-transfer-to-blanking.component.css']
})
export class MaterialTransferToBlankingComponent implements OnInit {
