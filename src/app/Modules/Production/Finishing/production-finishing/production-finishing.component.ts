...
@Component({
  selector: 'app-production-finishing',
  templateUrl: './production-finishing.component.html',
  styleUrls: ['./production-finishing.component.css']
})
export class ProductionFinishingComponent implements OnInit {
