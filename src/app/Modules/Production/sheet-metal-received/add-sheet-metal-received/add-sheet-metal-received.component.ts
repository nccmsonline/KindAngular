...
@Component({
  selector: 'app-add-sheet-metal-received',
  templateUrl: './add-sheet-metal-received.component.html',
  styleUrls: ['./add-sheet-metal-received.component.css']
})
export class AddSheetMetalReceivedComponent implements OnInit {
